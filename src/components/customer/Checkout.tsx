...
export default function Checkout({ cart, restaurant, onBack, onSuccess }: CheckoutProps) {
  const { user } = useAuth();
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-gray-600">Your food will arrive in approximately 45 minutes.</p>
        </div>
      </div>
    );
  }
