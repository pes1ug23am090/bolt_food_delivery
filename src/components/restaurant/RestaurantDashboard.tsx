    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 mb-4">No restaurant found for this account.</p>
          <button
            onClick={signOut}
        ...
        {view === 'menu' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {dishes.map(dish => (
                <div key={dish.id} className="bg-white rounded-xl shadow-sm p-4">
            ...
            {dishes.length === 0 && !showDishForm && (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-600">No dishes yet. Add your first dish to get started!</p>
              </div>
            )}
          </div>
        )}
